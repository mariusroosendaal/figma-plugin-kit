...
Seven skills for building Figma plugins with
...
- `mockup` — build a Figma mockup of a plugin UI from real UI3 component instances, from `PluginUI.svelte` or a description
